...
async function transfer() {
  const fromWalletId = process.env.STOREHOUSE_MAIN_WALLET_ID!;
  const toAddress = process.env.STOREHOUSE_TITHE_WALLET_ADDRESS!;
  const usdcTokenId = "15dc2b5d-0994-58b0-bf8c-3a0501148ee8";

  console.log("Sending 5 USDC: storehouse-main → storehouse-tithe...");
